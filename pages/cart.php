...
define('PAYPAL_RETURN_URL', 'https://www.projetfinalelgueta.fr/pages/success.php?id_user=' . $_SESSION["id_user"] . '');
define('PAYPAL_CANCEL_URL', 'https://www.projetfinalelgueta.fr/pages/cancel.php?id_user=' . $_SESSION["id_user"] . '');
...
// permet de proposer à l'utilisateur de modifier ses informations avant le paiement
if ($validCommande) {
...
// recup de la fonction recup_user permettant d'afficher les info de l'utilisateur
...
<?php } else { ?>
            ...
            <table class="table">
                    ...
                    <?php foreach ($recup_product as $row) { ?>
                        ...
                        <form class="form-tableau" action="cart.php?id_product=<?php echo $row->id_product ?>" method="post">
                            ...
                            <tr>
                                ...
                                <td name="somme_product"><?php echo number_format($prixQuantite, 2, '.', '') . "€"; ?></td>

                                <?php @$total += $prixQuantite ?>

                                <td><button class="trash" type="submit" name="delete_product" value="Supprimer"><i class="fas fa-trash-alt"></i></button></td>
                ...
                <tfoot class="pied_tableau">
                    <tr>
                        ...
                        <td><button id="valider" type="submit" name="validOrder" value="COMMANDER" data-toggle="collapse" data-target="#collapseCommande" aria-expanded="false" aria-controls="collapseCommande">COMMANDER</button>
                        </td>
                    </tr>
                </tfoot>
    ...
    <div class="container collapse_panier">
        <div class="col">
            <div class="collapse" id="collapseCommande">
                <div class="card card-body col_corps">
                    <div class="row">
                        <div class="container container_collapse_panier">
                            ...
                            <!-- FORMULAIRE PERMETTANT DE R2CUP2RER LES INFORMATIONS DES UTILISATEURS AVANT LE PAIEMENT -->
                            <form class="form_collapse" action="<?php echo PAYPAL_URL; ?>" method="post">
                                <div class="form-row form_ligne_collapse">
                                    <div class="form-group col-md-6 col_nom">
                                        ...
                                        <input class="input_nom" type="text" class="form-control" id="inputNom" name="nom" value="<?php echo $select_user->last_name ?>">
                                    </div>
                                    <!-- PRENOM DE L'UTILISATEUR -->
                                    <div class="form-group col-md-6 col_prenom">
                                        <label class="label_collapse" for="inputPrenom">Prénom : </label>
                                        <input class="input_prenom" type="text" class="form-control" id="inputPrenom" name="prenom" value="<?php echo $select_user->first_name ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col_email">
                                    ...
                                    <input class="input_email" type="email" class="form-control" id="inputAddressmail" placeholder="email" name="login" value="<?php echo $select_user->connection_identifier ?>">
                                </div>
                                <!-- PRIX TOTAL DE LA COMMANDE -->
                                <div class="form-group col_total">
                                    <label class="label_collapse" for="inputTotal">Total de votre panier :
                                    </label><br>
                                    <input class="input_total" type="text" class="form-control" id="inputTotal" value="<?php echo $total . "€"; ?>" disabled>
                                </div>
                                ...
                                <input type="hidden" name="item_name" value="<?php echo $select_user->first_name ?>">
