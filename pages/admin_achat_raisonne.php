...
$liste_titre_content =  liste_content();
//var_dump($liste_page);
?>
...
<h4>Modification du contenu de la page : "Achat raisonne, consommer mieux" :</h4>
  <form class="form-tableau" action="admin_achat_raisonne.php" method="post" enctype="multipart/form-data">
  <div class="form-row">
