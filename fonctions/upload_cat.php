...
function img_load_cat($id_category_shop)
{
    ...
    if (!empty(array_filter($_FILES['photos']['name']))) {
        ...
        if (!empty($insertValuesSQL)) {
            ...
            $insert = $connection->query("UPDATE shop_category SET img_category_shop =$insertValuesSQL  WHERE id_category_shop = $id_category_shop");
            if ($insert) {
